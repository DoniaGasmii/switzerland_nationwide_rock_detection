...
Example usage:
python run_inference.py --model yolo11_aug_tuning/exp_degrees_add/weights/best.pt --source data/inference/processed --output runs/inference --conf 0.10 --iou 0.40
"""
